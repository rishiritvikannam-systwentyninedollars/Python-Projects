...
student_profile = ("Rishi", "Grade 9", "Section A", 8)
...
monday_subjects = {"Algebra 2", "Chemistry Honors", "Tennis 1", "Robotics 1", "Advisory"}
tuesday_subjects = {"AP World Geography", "English 1", "Spanish 1", "Advisory"}
